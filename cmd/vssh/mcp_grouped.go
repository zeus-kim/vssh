...
func groupActions() map[string]map[string]string {
	return map[string]map[string]string{
		...
		"vssh_transport": {
			...
			"put": "vssh_put", "get": "vssh_get", "deploy_binary": "vssh_deploy_binary",
		},
		"vssh_route": {
...
func groupedMCPTools() []Tool {
	...
	tools := []Tool{
		...
		group("vssh_transport", "Move files, ship binaries, or port-forward. Set action. put=upload a file, get=download a file (both checksum-verified, policy-gated), deploy_binary=upload+atomic privileged install+optional service restart+verify, artifact_collect=file/dir evidence, tunnel=port-forward.", "put | get | deploy_binary | artifact_collect | tunnel", "vssh_put", "vssh_get", "vssh_deploy_binary", "vssh_artifact_collect", "vssh_tunnel"),
